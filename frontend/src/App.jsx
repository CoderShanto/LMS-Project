...
import AdminDashboard from './components/pages/Admin/index'
import PaymentSettings from './components/pages/Admin/PaymentSettings' // ✅ Different
...
<Route path="/admin"
  element={
    <RequireAuth>
      <AdminDashboard />  {/* ✅ This is correct */}
    </RequireAuth>
  } 
/>
