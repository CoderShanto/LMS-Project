                            ...
                            <div className='col-md-12'> 
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className='mb-3'>
                                            ...
                                            <input type='password' 
                                            {
                                                ...register('old_password', { required:"The old password field is required" })
                                            }
                                         ...
                                         <div className='mb-3'>
                                            ...
                                            <input type='password' 
                                            {
                                                ...register('new_password', { required:"The new password field is required" })
                                            }
                                        ...
                                        <div className='mb-3'>
                                            ...
                                            <input type='password' 
                                            {
                                                ...register('confirm_password', { 
                                                  ...
                                                  validate: (value) => {
                                                    return newPassword === value || "The passwords do not match"
                                                  }
