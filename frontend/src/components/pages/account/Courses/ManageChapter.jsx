...
const ManageChapter = ({course, params}) => {
     const [loading, setLoading] = useState(false);
      ...
      const [lessonsData, setLessonsData] = useState([]);
       ...
       // Modal state for updating chapter
         ...
         const handleShow = (chapter) => {
          ...
          // Modal state for creating lesson model
        ...
        <div className="card-body p-4">
          <div className="d-flex">
            ...
            <div className='d-flex justify-content-between w-100'>
                     ...
                     <h4 className="h5 mb-4">Chapters</h4>
                     <div>
                        <Link onClick={() => handleShowLessonModel()}><FaPlus size={12}/><strong> Create Lesson</strong> </Link>
                    ...
                    return(
                        ...
                        <Accordion.Body>
                          ...
                          <div className='row'>
                            ...
                            <RiDragMove2Fill /><strong> Reorder Lessons</strong></Link>
                            ...
                            chapter.lessons && chapter.lessons.map(lesson => {
                              return(
                                <div key={lesson.id} className='card shadow px-3 py-2 mb-2 rounded'>
                                  <div className='row'>
                            ...
                            className='btn btn-danger btn-sm shadow-lg'>Delete Chapter</button>

                            <button
                            onClick={() => handleShow(chapter)}
                            className='btn btn-primary btn-sm ms-2 shadow-lg'>Update Chapter</button>
                          </div>
                              </div>
                          </div>
