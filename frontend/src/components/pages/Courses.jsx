                                    ...
                                    <ul>
                                        {
                                            ...
                                            <div className="form-check">
                                                <input 
                                                defaultChecked={searchParams.get('category') ? searchParams.get('category').
                                    ...
                                    <ul>
                                        {
                                            ...
                                            <div className="form-check">
                                                <input 
                                                defaultChecked={searchParams.get('level') ? searchParams.get('level').
                                                    includes(level.id) : false}
                                    ...
                                    <ul>
                                        {
                                            ...
                                            <div className="form-check">
                                                <input 
                                                defaultChecked={searchParams.get('language') ? searchParams.get('language').
                                                    includes(language.id) : false}
